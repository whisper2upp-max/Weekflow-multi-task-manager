        ...
        <article className="document-content">
          ...
          <section>
            ...
            <ul>
              ...
              <li><b>Task Management:</b> Create and edit Tasks with completion status and related documents. Progress is stored as multiple timestamped rich-text records; double-click Progress to open the latest record and select earlier records for review or editing. Urgency, Report To, and Deliverable are required.</li>
          ...
          <section>
            <h3>Excel Export</h3>
            <p>Export Dashboard Report creates an <code>.xlsx</code> file with Overall Dashboard, Timeline Dashboard, and Progress History worksheets.</p>
            <p>The Timeline Dashboard keeps all progress records for a Task in one wrapped cell, newest first. Progress History lists one record per row with timestamps and source. The file also includes every Task, Group and Flow statistics, step numbers, recurrence and date ranges, the weekly DDL timeline, and full links.</p>
      ...
      <article className="document-content">
        ...
        <section>
          ...
          <ul>
            ...
            <li><b>Task 管理：</b>创建和编辑 Task，可维护完成状态和相关资料；进度支持多条带时间戳的富文本记录，双击默认打开最后一条，也可选择过往记录预览和编辑。紧急程度、汇报对象和交付物为必填项。</li>
        ...
        <section>
          <h3>Excel 导出</h3>
          <p>点击“导出看板报告”会生成包含“整体看板”“时间表看板”和“进度历史”的 <code>.xlsx</code> 文件。</p>
          <p>“时间表看板”的进度记录单元格按新到旧换行显示该 Task 的全部记录；“进度历史”按一条记录一行列示时间戳和来源。文件同时包含全部 Task、分组和 Flow 统计、步骤序号、周期及起止日期、DDL 周时间轴与完整链接。</p>

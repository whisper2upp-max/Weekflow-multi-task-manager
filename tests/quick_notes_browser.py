...
with sync_playwright() as playwright:
    ...
    page.screenshot(path="/tmp/weekflow-v3.1-note-color-palette.png", full_page=False)
    ...
    page.screenshot(path="/tmp/weekflow-v3.1-progress-history-en.png", full_page=False)
    ...
    page.screenshot(path="/tmp/weekflow-v3.1-task-conversion-en.png", full_page=False)
    ...
    page.screenshot(path="/tmp/weekflow-v3.1-date-prefixed-drafts.png", full_page=False)
    page.once("dialog", lambda dialog: dialog.accept())
    page.locator('[data-action="close-task-dialog"]').first.click()
    assert not task_dialog.is_visible()
    ...
    page.screenshot(path="/tmp/weekflow-v3.1-quick-notes-en.png", full_page=False)

    page.get_by_role("button", name="Timeline", exact=True).click()
    page.locator(".more-menu > summary").click()
    with page.expect_download() as backup_info:
        page.locator('[data-action="export-json"]').click()
    backup_path = Path("/tmp/weekflow-v3.1-full-backup.json")
    ...
    print(Path("/tmp/weekflow-v3.1-quick-notes-en.png"))
